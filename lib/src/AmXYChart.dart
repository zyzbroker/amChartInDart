...
class AmXYChart extends AmRectangularChart {
  // @Ignore
  AmXYChart.fakeConstructor$() : super.fakeConstructor$();

  /// Specifies if Scrollbar of X axis (horizontal) should be hidden.
  external bool get hideXScrollbar;
  external set hideXScrollbar(bool v);

  /// Specifies if Scrollbar of Y axis (vertical) should be hidden.
  external bool get hideYScrollbar;
  external set hideYScrollbar(bool v);

  /// Maximum zoom factor of the chart.
  /// @default 20
  external num get maxZoomFactor;
  external set maxZoomFactor(num v);
